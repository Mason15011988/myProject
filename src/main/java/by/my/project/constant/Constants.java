...
public final class Constants {
    ...
    public static final String CHOICE_ADD_ROOM = "choiceAddRoom";
    public static final String REGISTRATION = "registration";
    public static final String REGISTRATION_USER = "registrationUser";
    public static final String REGISTRATION_ADMIN_HOTEL = "registrationAdminHotel";
    public static final String LOGIN = "login";
    public static final String LOGIN_USER = "loginUser";
    public static final String LOGIN_ADMIN_HOTEL = "loginAdminHotel";
    public static final String SAVE_ROOM = "saveRoom";
